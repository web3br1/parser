...
- Jobs total: 77
- Jobs by status: `{"succeeded": 77}`
- Jobs by type: `{"classification": 20, "extraction": 37, "ingest": 20}`
- Job failures: 0

## Pre-Review Summary

- Counts: `{"chunks": 20, "facts": 41, "published_facts": 39, "published_rules": 9, "rules": 10, "sources": 20, "unknowns": 6}`
- Chunk statuses: `{"extracted": 17, "needs_review": 3}`
- Fact statuses: `{"extracted": 2, "published": 39}`
- Rule statuses: `{"extracted": 1, "published": 9}`
- Unknown statuses: `{"open": 6}`
- Fact types: `{"business_hours": 22, "contact_info": 2, "faq_item": 4, "payment_method": 4, "service_price": 9}`
...
- Actions attempted: 3
- Failed actions: 0
- Post-review counts: `{"chunks": 20, "facts": 41, "published_facts": 41, "published_rules": 10, "rules": 10, "sources": 20, "unknowns": 6}`
- Post-review fact statuses: `{"published": 41}`
