from worker_classification.celery_app import create_celery_app


def test_create_classification_celery_app_enables_eager_mode_without_redis(monkeypatch):
...
def test_create_classification_celery_app_uses_dedicated_queue_and_broker_override(
    monkeypatch,
    tmp_path,
):
